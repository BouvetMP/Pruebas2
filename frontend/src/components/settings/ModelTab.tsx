...
export function ModelTab() {
  ...
  const rangeNameStyle: React.CSSProperties = {
    fontSize: '13px',
    fontWeight: 600,
      ...
      <Card>
        ...
        <CardBody>
          <Toggle
            ...
            description={`Bloquear TXN con riesgo > ${autoBlockThreshold}%`}
            checked={autoBlock}
          ...
          <div style={rangeRowStyle}>
            ...
            <input
              ...
              onChange={(e) => setAutoBlockThreshold(+e.target.value)}
              style={{ width: '120px' }}
            />
          ...
          <Toggle
            ...
            description="Procesar transacciones en tiempo real"
            checked={realtimeAnalysis}
            onChange={setRealtimeAnalysis}
          />
          <Toggle
            label="Whitelist"
            description="Excluir usuarios/bancos de confianza"
